  ...
  return (
    ...
    sm:gap-10 sm:mt-6 gap-8 text-base mt-5 animate-fade-in"> 
        <div>
            ...
            <div>
                <h1 className="mt-4">Communication</h1>
            ...
            <div>
                <h1 className="mt-4">Time management</h1>
                <div className="lg:w-80 lg:h-6 md:w-72 md:h-5 md:mt-1 sm:w-56 sm:h-5 sm:mt-1 w-36 h-4 mt-1 bg-gray-400 rounded-md"><div className="h-full w-3/5 bg-red-700 rounded-s-md 
                animated-bar70"></div></div>
            </div>
            <div>
                <h1 className="mt-4">Stress management</h1>
        ...
        <div>
            ...
            <div>
                <h1 className="mt-4">The audacity</h1>
                <div className="lg:w-80 lg:h-6 md:w-72 md:h-5 md:mt-1 sm:w-56 sm:h-5 sm:mt-1 w-36 h-4 mt-1 bg-gray-400 rounded-md"><div className="h-full w-4/5 bg-red-700 rounded-s-md
                animated-bar60 "></div></div>
            </div>
            <div>
                <h1 className="mt-4">Motivation</h1>
                <div className="lg:w-80 lg:h-6 md:w-72 md:h-5 md:mt-1 sm:w-56 sm:h-5 sm:mt-1 w-36 h-4 mt-1 bg-gray-400 rounded-md"><div className="h-full w-2/5 bg-red-700 rounded-md 
                animated-bar100"></div></div>
            </div>
            <div>
